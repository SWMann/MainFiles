    ...
    return (
        ...
        <div className="w-full max-w-3xl mx-auto bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <form className="px-8 py-6 space-y-6">
                ...
                <div className="space-y-2" style={{textAlign:"center", marginLeft: "auto", marginRight: "auto"}}>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300"
                               htmlFor="initial-mos">
                            Requested Branch
                        </label>
                        <select
                            className="block  w-auto px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            id="initial-mos"
                        >
                            <option value="">Select Branch</option>
                            <option value="rifleman">Imperial Navy</option>
                            <option value="grenadier">Imperial Guard</option>
                ...
                <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        ...
                        Why do you want to join our unit?
